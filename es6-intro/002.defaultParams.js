...
const groceryShopAction = (food = "something") => `I'm going to buy ${food} from the grocery shop`;

console.log(groceryShopAction("sushi"));
// returns I'm going to buy sushi from the grocery shop

console.log(groceryShopAction());
// returns I'm going to buy something from the grocery shop